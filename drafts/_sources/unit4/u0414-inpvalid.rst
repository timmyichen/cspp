...
One of the basics of cybersecurity and writing code is that: nobody should be able to crash your code.  Whenever you ask a user for input, you have to assume every possible case that they can throw at you.  Breakable code is not secure code.
...
With negative numbers, we know that the negative sign will always be in the front of the number.  This is good because it allows us to write a quick test to see if that is true: